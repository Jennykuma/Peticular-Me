...
public class BottomSheet extends AppCompatActivity{
    ...
    public void openBottomSheet (View v) {
        ...
        final Dialog mBottomSheetDialog = new Dialog (BottomSheet.this,
        ...
        txtBackup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(BottomSheet.this,"Clicked E-mail",Toast.LENGTH_SHORT).show();
        ...
        txtDetail.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Toast.makeText(BottomSheet.this,"Clicked Detail",Toast.LENGTH_SHORT).show();
                mBottomSheetDialog.dismiss();
            }
        });
        ...
        txtOpen.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Toast.makeText(BottomSheet.this,"Clicked Open",Toast.LENGTH_SHORT).show();
                mBottomSheetDialog.dismiss();
            }
        });
        ...
        txtUninstall.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Toast.makeText(BottomSheet.this,"Clicked Print",Toast.LENGTH_SHORT).show();
                mBottomSheetDialog.dismiss();
            }
        });
    }
